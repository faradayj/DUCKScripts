/*
name: Void Xyfrag DUCK
description: Seven-player DUCK script for Void Xyfrag.
tags: void, xyfrag, challenge boss, seven-player, army, coreduck
*/
...
public class VoidXyfragDUCK
{
    ...
    private const string LogPrefix = "Void Xyfrag DUCK";
    private const string SyncFileName = "VoidXyfragDUCK.sync";
    ...
    public string OptionsStorage = "VoidXyfragDUCK";
    ...
    private void ExecuteScript()
    {
        ...
        Core.AddDrop(XyfragEssence);
        Core.AddDrop(XyfragEssenceId);
    ...
    private bool RunFightAttempts(ClassPreset preset)
    {
        for (int fightAttempt = 1; fightAttempt <= MaxFightAttempts && !Bot.ShouldExit; fightAttempt++)
        {
            ...
            try
            {
                ...
                bool CreditCheck() =>
                    Duck.HasItemAnywhere(XyfragEssence, XyfragEssenceId)
