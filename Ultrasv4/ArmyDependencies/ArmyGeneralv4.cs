...
public class ArmyGeneralv4
{
    public ArmyGeneralv4() { }
    ...
    public static void PrepareClassSync(CoreUltrav4 ultra, IScriptInterface bot, int armySize, string syncFilePath)
    {
        if (ultra == null || bot == null || armySize < 1 || string.IsNullOrWhiteSpace(syncFilePath))
            return;

        UltraGeneralv4.EquipUltraDailyPresetClassesSafe(ultra, bot, syncFilePath, armySize);
    }

    public static void PrepareStageSync(CoreUltrav4 ultra, string syncFilePath)
    {
    ...
    public static bool IsFullArmyActive(CoreUltrav4 ultra, string syncFilePath, int armySize)
    {
    ...
    public static int PublishAndGetArmyStage(CoreUltrav4 ultra, IScriptInterface bot, int ownStage, string syncFilePath, int armySize)
    {
