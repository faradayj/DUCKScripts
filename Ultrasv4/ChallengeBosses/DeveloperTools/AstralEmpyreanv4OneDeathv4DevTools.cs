...
public class AstralEmpyreanv4OneDeathv4DevTools
{
    ...
    private void Fight()
    {
        ...
        while (!Bot.ShouldExit)
        {
            ...
            {
                _deathRetries++;
                C.Logger($"[AstralEmpyreanv4] Army death detected. Retreating. Retry {_deathRetries}/{MaxDeathRetries}.");
            ...
            {
                _deathRetries++;
                C.Logger($"[AstralEmpyreanv4] Death detected. Retry {_deathRetries}/{MaxDeathRetries}.");
